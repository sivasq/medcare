<div class="slim-header">
	<div class="container">
		...
		<div class="slim-header-right">
			<div class="dropdown dropdown-a d-none">
			...
			<div class="dropdown dropdown-b d-none">
				<a href="" class="header-notification" data-toggle="dropdown">
					...
					<div class="dropdown-list">
						...
						<a href="" class="dropdown-link read">
							<div class="media">
								<img src="http://via.placeholder.com/500x500" alt="">
								<div class="media-body">
									<p><strong>Julius Erving</strong> wants to connect with you on your conversation
			...
			<div class="dropdown dropdown-c">
				...
				<div class="dropdown-menu dropdown-menu-right">
					<nav class="nav">
						{{--<a href="{{ url('user/create') }}" class="nav-link"><i class="icon ion-person-add"></i> Create Account</a>--}}
						...
						<a href="{{ route('logout') }}" class="nav-link"
						   onclick="event.preventDefault();document.getElementById('logout-form').submit();">
							<i class="icon ion-forward"></i> {{ __('Sign Out') }}</a>
