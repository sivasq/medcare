	...
	<div class="slim-mainpanel">
		<div class="container">
			...
			<div class="section-wrapper">
					...
					<div class="wd-300">
						<div class="d-md-flex mg-b-30">
							<div class="form-group mg-b-0">
								...
								<input type="text" name="firstname" class="form-control wd-250"
								       placeholder="Enter firstname" required>
							</div><!-- form-group -->
							<div class="form-group mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
								<label>Lastname: <span class="tx-danger">*</span></label>
								<input type="text" name="lastname" class="form-control wd-250"
				...
				<table class="table table-reference">
					...
					<tr>
						...
						<td>Parsley the validator looks at all data-parsley-validate occurrences in DOM on document load
							and automatically binds them if valid.
						</td>
					</tr>
					<tr>
			...
			<div class="section-wrapper mg-t-20">
				...
				<p class="mg-b-20 mg-sm-b-40">A demo of an email field that is required and must also be a valid email
					address.
				...
				<form action="form-validation.html" data-parsley-validate>
					<div class="d-sm-flex wd-sm-300">
						<div class="form-group mg-b-0">
							...
							<input type="email" name="email" class="form-control wd-150 wd-xs-250"
			...
			<div class="section-wrapper mg-t-20">
				...
				<p class="mg-b-20 mg-sm-b-40">A demo of checkboxes that must be selected at least two fom any given
					list.</p>
				...
				<table class="table table-reference table-responsive">
					...
					<tr>
						...
						<td>Specify the existing DOM container where ParsleyUI should add error and success classes.
						</td>
					</tr>
					<tr>
						<td><code class="pd-0 bg-transparent">data-parsley-errors-container="#cbErrorContainer"</code>
						</td>
			...
			<div class="section-wrapper mg-t-20">
				...
				<p class="mg-b-20 mg-sm-b-40">A demo of select boxes that must be selected at least one fom any given
					option.</p>
					...
					<div class="wd-300">
						<div class="d-md-flex mg-b-30">
							<div id="fnWrapper" class="parsley-input">
								<label>Firstname: <span class="tx-danger">*</span></label>
								<input type="text" name="firstname" class="form-control wd-250"
								       placeholder="Enter firstname" data-parsley-class-handler="#fnWrapper" required>
							</div><!-- form-group -->
							<div id="lnWrapper" class="parsley-input mg-md-l-20 mg-t-20 mg-md-t-0">
								<label>Lastname: <span class="tx-danger">*</span></label>
								<input type="text" name="lastname" class="form-control wd-250"
								       placeholder="Enter lastname" data-parsley-class-handler="#lnWrapper" required>
							</div><!-- form-group -->
						</div><!-- d-flex -->
					</div>
					<p class="mg-b-10">What is your favorite browser? <span class="tx-danger">*</span></p>
