...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `work_live_status` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'work progress status',
...
REPLACE INTO `work_queues` (`id`, `client_id`, `e_script_id`, `reviewer_id`, `status`, `summary_report`, `chat_status`, `created_at`, `updated_at`) VALUES
	...
	(2, 1, NULL, NULL, 'assigned', 'pending', NULL, NULL, NULL),
	(3, 1, NULL, NULL, 'in progress', 'pending', NULL, NULL, NULL),
	(4, 1, NULL, NULL, 'completed', 'pending', NULL, NULL, NULL);
